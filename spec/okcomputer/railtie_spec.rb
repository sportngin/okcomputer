...
describe OKComputer::Railtie do

  it "exists" do
    OKComputer::Railtie.should < Rails::Railtie
  end
  ...
  context "#ignore_newrelic" do
    ...
    context "#when NewRelic is installed" do
      ...
      it "should inject newrelic_ignore" do
        ...
        OKComputer::Railtie.send(:ignore_newrelic)
      end
    end
    ...
    context "#when NewRelic is not installed" do
      it "should not inject newrelic_ignore" do
        ...
        expect{ OKComputer::Railtie.send(:ignore_newrelic) }.to_not raise_error
      end
    end
  end
end
